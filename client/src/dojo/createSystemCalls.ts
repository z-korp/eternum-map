...
export function createSystemCalls({ provider }: SetupNetworkResult) {
  ...
  const accept_partial_order = async (
    props: SystemProps.AcceptPartialOrderProps
  ) => {
  ...
  const create_multiple_realms_dev = async (
    props: SystemProps.CreateMultipleRealmsDevProps
  ) => {
  ...
  const transfer_resources = async (
    props: SystemProps.TransferResourcesProps
  ) => {
  ...
  const create_hyperstructure = async (
    props: SystemProps.CreateHyperstructureProps
  ) => {
  ...
  const transfer_guild_ownership = async (
  ...
  const remove_player_from_whitelist = async (
  ...
  const battle_force_start = async (
    props: SystemProps.BattleForceStartProps
  ) => {
  ...
  const battle_leave_and_claim = async (
    props: SystemProps.BattleClaimAndLeaveProps
  ) => {
    await provider.battle_claim_and_leave(props);
  };

  const battle_leave_and_pillage = async (
    props: SystemProps.BattleLeaveAndRaidProps
  ) => {

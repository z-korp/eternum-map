  ...
  return {
    ...
    GuildWhitelist: (() => {
      return defineComponent(
        world,
        {
          ...
          is_whitelisted: RecsType.Boolean,
        },
        {
          metadata: {
            namespace: 's1_eternum',
    ...
    QuestConfig: (() => {
      return defineComponent(
        ...
        {
          config_id: RecsType.Number,
          production_material_multiplier: RecsType.Number,
        },
        {
          metadata: {
            namespace: 's1_eternum',
    ...
    QuestRewardConfig: (() => {
      return defineComponent(
        world,
        {
          ...
          detached_resource_id: RecsType.Number,
          detached_resource_count: RecsType.Number,
        },
        {
          metadata: {
            namespace: 's1_eternum',
    ...
    Stamina: (() => {
      return defineComponent(
        world,
        {
          ...
          last_refill_tick: RecsType.BigInt,
        },
        {
          metadata: {
            namespace: 's1_eternum',
    ...
    TickConfig: (() => {
      return defineComponent(
        world,
        {
          ...
          tick_interval_in_seconds: RecsType.BigInt,
        },
        {
          metadata: {
            namespace: 's1_eternum',
